(function(){
  ...
  if(!document.querySelector('script[data-compare-row-fixes]')){const s=document.createElement('script');s.dataset.compareRowFixes='1';s.src='athlete-compare-row-fixes.js?v=20260816-stable23-'+Date.now();document.body.appendChild(s);}
  ...
  const p=document.createElement('script');p.dataset.compareModalPbHardfix='1';p.src='athlete-compare-modal-pb-hardfix.js?v=20260816-pb-box2-'+Date.now();document.body.appendChild(p);
})();