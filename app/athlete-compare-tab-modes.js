(function(){
  ...
  const s=document.createElement('script');s.dataset.compareForecastLayout='1';s.src='athlete-compare-forecast-layout.js?v=20260815-row3-'+Date.now();document.body.appendChild(s);
})();