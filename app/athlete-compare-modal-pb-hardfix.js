(function(){
  ...
  async function apply(){
    ...
    const card=modal.querySelector('.modal-card');if(card){card.style.width='min(760px,calc(100vw - 24px))';card.style.maxWidth='760px';card.style.padding='16px 20px 18px';card.style.maxHeight='calc(100vh - 24px)';card.style.overflowY='auto';}
    box.style.cssText='margin-top:10px;padding:10px 14px;background:#102a45;border-radius:8px;display:grid!important;grid-template-columns:1fr 1fr!important;align-items:end!important;gap:20px!important';
